						...
						<div class="col-xs-12 col-sm-12" >   
							...
							<div class="col-md-6">
								<ul class="dog-list-items"> 
								 <li class="parent"><span class="text"> Hips, Eyes, and Elbows Certified, DNA tests conducted</span></li>
					...
					<div class="row dog-gallery-row">
						<div class="col-md-12"> 
							<?php 
								...
								$dog = "https://graph.facebook.com/v2.3/10152270725645596/photos?fields=source&access_token={$access_token}";
