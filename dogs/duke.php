					...
					<div class="row main-row" > 					 
						<div class="col-xs-12 col-sm-12" >    
							<div class="page-section-title"   > 
								Duke: Police K-9 - Available for Sale to Police Department
							</div>
						</div>
					</div>
					<div class="row " > 					 
						<div class="col-xs-12 col-sm-12" >   
							<div class="col-md-6" style="margin-top:20px"> 
								...
								<div class="row">  
									...
									<div class="col-md-9 dog-single-right"> Dutch Shepherd  </div> 
								</div>
								<div class="row">  
									<div class="col-md-3 dog-single-left">Date of Birth</div>
									<div class="col-md-9 dog-single-right"> February 26, 2014  </div> 
								</div>
								<div class="row">  
									<div class="col-md-3 dog-single-left">Dam</div>
									<div class="col-md-9 dog-single-right"> Pip (Dhr. J.R. Kelley, USA) </div>
								</div>  
								<div class="row">  
									<div class="col-md-3 dog-single-left">Sire</div>
									<div class="col-md-9 dog-single-right"> Pelle (Dhr. B. Huijis, Baarlo) </div>
								</div>  
								<div class="row">  
							...
							<div class="col-md-6">
								<ul class="dog-list-items"> 
								  ...
								  <li class="child"><span class="text">Duke is a fast and quick Dutch Shepherd. A lovable, social, and friendly dominant male, he possesses the athleticism and speed to strike through decoy or helper. This is an extremely high drive dog in all facets: high hunt, high prey, high toy, and high food.   </span></li>
					...
					<div class="row dog-gallery-row">
						<div class="col-md-12"> 
							<?php 
								...
								$dog = "https://graph.facebook.com/v2.3/10155119454660596/photos?fields=source&access_token={$access_token}";
