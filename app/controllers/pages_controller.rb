class PagesController < ApplicationController
  ...
  def dogs
    ...
    begin
      @dogs =    @api.rest_call("fql.multiquery", {:queries => {
                        ...
                        "89" => "SELECT src_big FROM photo WHERE aid = '100000256514752_124310' LIMIT 10" }.to_json})
  ...
  def gallery
    ...
    @api = Koala::Facebook::GraphAndRestAPI.new("AAAFdvM04JnQBAMZBmVuYMWes5rrYBmqWXOmhkPjQpenbbZA2qC3Yqq2acC0brNxru91nqj6ZCvdle9ZCeGaTo9Ndd5VwvlvmI0Uj79CkYwZDZD")
